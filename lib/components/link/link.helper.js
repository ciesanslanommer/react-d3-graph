...
function buildLinkPathDefinition() {
  ...
  var roughOpts = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
  var offset = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;
  var breakPoints = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : [];
  var sourceId = arguments.length > 6 ? arguments[6] : undefined;
  var targetId = arguments.length > 7 ? arguments[7] : undefined;
  var selfLinkDirection =
    arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : _link.SELF_LINK_DIRECTION.TOP_RIGHT;
  var sx, sy, tx, ty;

  if (offset) {
    var _shorterLine = (0, _shorten.shorterLine)(sourceCoords, targetCoords, offset, offset);
  ...
  if (type === _link.LINE_TYPES.ROUGH) {
    return (0, _rough.roughLine)(sx, sy, tx, ty, roughOpts);
  }
